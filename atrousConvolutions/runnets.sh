<<<<<<< HEAD
python multiscaleNet.py --model='MDAC' --maxSteps=7001 --dispIt=25 --batchSize=8 --lR=9e-6 --restore=False

python multiscaleNet.py --model='UNet' --maxSteps=7001 --dispIt=25 --batchSize=8 --lR=9e-6 --restore=False

python simplyFullyCNNet.py --maxSteps=7001 --dispIt=25 --batchSize=8 --lR=9e-6 --restore=False
=======
